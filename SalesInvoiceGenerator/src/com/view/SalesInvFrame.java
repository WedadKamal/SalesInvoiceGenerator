...
public class SalesInvFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SalesInvFrame frame = new SalesInvFrame();
    ...
    private MyListner listener = new MyListner(this);
    public static SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
    private ArrayList<InvoiceHeader> invoices;
    private HeadTablMod headerTableModel;
    ...
    public HeadTablMod getHeaderTableModel() {
        return headerTableModel;
    }

    public void setHeaderTableModel(HeadTablMod headerTableModel) {
